...
{
    std::cout << "Polynome : " << expression << std::endl;

    std::cout << "Minimum trouve : ";

    if (minimum.size() == 1)
    {
        std::cout << "x = " << minimum[0];
    }
    else
    {
        std::cout << "(";
    ...
    {
        std::cout << "x = " << minimumTheorique[0];
    }
    else
    {
        std::cout << "(";

        for (size_t i = 0; i < minimumTheorique.size(); ++i)
        {
...
int main()
{
    ...
    std::vector<double> minimum1 =
        nm.minimiser(f1, s1, 1000, 0.000001);
    ...
    std::vector<double> minimum2 =
        nm.minimiser(f2, s2, 1000, 0.000001);
    ...
    std::vector<double> minimum3 =
        nm.minimiser(f3, s3, 1000, 0.000001);
